...
public class Main {
    ...
    private static void sendNewMessage() {
        ...
        String name = s.next();
        if(name.equals("")){
            System.out.println("Please enter the name of a contact");
            sendNewMessage();
        }
        else {
    ...
    private static void addNewContact() {
        ...
        if (name.equals("") || number.equals("") || email.equals("")) {
            System.out.println("Please enter all of the information0");
            addNewContact();
        } else {
            ...
            if (doseExist) {
                System.out.println("We have a contact named " + name + " saved onthis device");
                addNewContact();
            } else {
